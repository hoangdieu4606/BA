    ...
    <div className="table-container">
      <div className="table-toolbar">
        ...
        <div className="toolbar-actions">
          ...
          <button className="icon-btn" style={{ marginRight: '12px' }} onClick={() => setSearchTerm('')}>🔄</button>
          <button className="text-btn active" style={{ marginRight: '12px' }}>📄 Danh sách</button>
          <button className="text-btn" style={{ marginRight: '12px' }} onClick={handleExportExcel} title="Xuất dữ liệu sang file Excel">📥 Xuất Excel</button>

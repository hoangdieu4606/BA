          ...
          <tbody>
            {personnel.map((person, index) => (
              <tr key={index} className="table-row">
                ...
                <td>{person.tuoi || <span style={{color: 'var(--text-muted)'}}>--</span>}</td>
                <td>{person.sucKhoe || <span style={{color: 'var(--text-muted)'}}>--</span>}</td>
                <td>
                  <span className={`badge-class ${person.dangTapHuan === 'Có' ? 'success' : 'warning'}`}>
                    {person.dangTapHuan || 'Không'}
                  </span>
                </td>

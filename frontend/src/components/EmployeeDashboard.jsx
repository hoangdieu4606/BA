...
const EmployeeDashboard = ({ traceabilityList = [], setTraceabilityList }) => {
  ...
  return (
    <div className="employee-dashboard">
      ...
      {/* Details Modal */}
      {selectedRecord && (
        <div className="modal-backdrop" onClick={() => { setSelectedRecord(null); setIsEditing(false); }}>
          <div className="modal-content" onClick={(e) => e.stopPropagation()} style={{ maxWidth: isEditing ? '750px' : '650px' }}>
            <div className="modal-header">
              ...
              <button className="close-btn" onClick={() => { setSelectedRecord(null); setIsEditing(false); }}>&times;</button>
            </div>
            <div className="modal-body" style={isEditing ? { padding: '20px 24px' } : {}}>
              {isEditing ? (
                <div>
                  ...
                  {/* Show live updating GS1 QR code at the bottom of edit view */}
